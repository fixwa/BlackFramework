...
class Router
{
     ...
     *
     * @param string $method One of 4 HTTP Methods, or a pipe-separated list of multiple
     ...
     * @param string $name Optional name of this route. Supply if you want to reverse route this url
     *               in your application.
     */
