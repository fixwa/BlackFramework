...
class Xcrud_config
{
    ...
    // editor
    public static $editor_url = '/Assets/xcrud/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    // xcrud folder url
    public static $scripts_url = '/Lib/xcrud/'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
